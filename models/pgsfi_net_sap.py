...
from models.spatial_freq_domain import VesselPriorExtractor


class PGSFINetSAP(nn.Module):
    """渐进式添加：baseline(UNet factor=4) + SAP（先验模块）"""

    def __init__(self, n_channels, n_classes, downsize_nb_filters_factor=4, dropout_rate=0.1):
        super(PGSFINetSAP, self).__init__()
