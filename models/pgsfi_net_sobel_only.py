...
from models.spatial_freq_domain import (
    ...
    VesselPriorExtractorSobelOnly,
    Plain_Four_SAFM_Block,
    DecoderParallelBlock
)


class PGSFINetSobelOnly(nn.Module):
    """消融：完整版，但 SAP 中去掉空间注意力（Sobel-only）"""

    def __init__(self, n_channels, n_classes, downsize_nb_filters_factor=4, dropout_rate=0.1):
        super(PGSFINetSobelOnly, self).__init__()
        ...
        self.prior_extractor = VesselPriorExtractorSobelOnly(in_channels=1, out_channels=64 // f)
