...
class PGSFINetLocalOnly(nn.Module):
    """消融：LGF 只保留 differential CNN local branch（关闭 channel self-attention global branch）"""

    def __init__(self, n_channels, n_classes, downsize_nb_filters_factor=4, dropout_rate=0.1):
        super(PGSFINetLocalOnly, self).__init__()
        ...
        self.decoder_block1 = DecoderParallelBlock(256 // f, branch_type='local_only')
        self.decoder_block2 = DecoderParallelBlock(128 // f, branch_type='local_only')
        self.decoder_block3 = DecoderParallelBlock(64 // f, branch_type='local_only')
        self.decoder_block4 = DecoderParallelBlock(64 // f, branch_type='local_only')
